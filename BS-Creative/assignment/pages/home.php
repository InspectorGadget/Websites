...
<html>
<head>
    <title>Home - Biblical Studies Creative</title>
</head>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2>Jack finally did an assignment!</h2>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-lg-offset-2">
                <p>This assignment utilizes a <a class="-external-link" href="#">bootstrap template</a>, you can also download this projects source via <a class="-external-link" href="#">GitHub</a>.</p>
            </div>
            <div class="col-lg-4">
